...
2. `python3 -m pip-audit -r backend/requirements.txt` — FAIL — Tool not installed in env; prior run reported protobuf 6.33.4 (GHSA-7gcm-g887-7qv7). Pinned to 6.33.3 to avoid the vulnerable release; rerun in CI once pip-audit is available.
